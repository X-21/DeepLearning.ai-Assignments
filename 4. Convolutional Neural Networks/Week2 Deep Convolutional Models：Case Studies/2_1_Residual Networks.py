...
def ResNet50(input_shape=(64, 64, 3), classes=6):
    ...
    # Stage 2
    X = convolutional_block(X, f=3, filters=[64, 64, 256], stage=2, block='a', s=1)  # 15,15,256
    ...
    # Stage 4 (≈6 lines)
    X = convolutional_block(X, f=3, filters=[256, 256, 1024], block='a', stage=4, s=2)  # 4,4,1024
    ...
    X = AveragePooling2D(pool_size=(2, 2))(X)  # 1,1,2048
