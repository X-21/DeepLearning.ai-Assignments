...
abs_f_p = os.path.abspath("data/original_metheny.mid")
musical_data_my = get_musical_data(abs_f_p)
chords, abstract_grammars = musical_data_my #get_musical_data('data/original_metheny.mid')
